import { Container, Form, ProductImage, Name, Category, Ingredients, Price, Description, Buttons } from "./styles";
            ...
            <main>
                ...
                <Form>
                    ...
                    <div className="deleteButton">
                        <Button title="Excluir Prato" className="deleteButton" style={{ fontSize: "14px" }} />
                    </div>
                    <div className="saveButton">
                        <Button title="Salvar alterações" style={{ fontSize: "14px" }} />
                    </div>
                    </Buttons>
                </Form>
            </main>
